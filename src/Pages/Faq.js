            ...
            <div className='w-5/6 mx-auto'>
                ...
                <div className='text-center bg-amber-100 p-5'>
                    ...
                    <div className='cursor-pointer' onClick={() => setq1(!q1)}>
                        <h3 className='font-bold hover:font-extrabold mb-3 text-lg'>How to order?</h3>
                    ...
                    <div className='cursor-pointer' onClick={() => setq2(!q2)}>
                        <h3 className='font-bold hover:font-extrabold text-lg mb-3'>How is your order billed to you?</h3>
                    ...
                    <div className='cursor-pointer' onClick={() => setq3(!q3)}>
                        <h3 className='font-bold hover:font-extrabold text-lg mb-3'>How do you return merchandise that does not meet your expectations?</h3>
                ...
                <h3 className='text-center mt-5 text-blue-600 hover:underline cursor-pointer'>Have a different question? Send us a message</h3>
            </div>
